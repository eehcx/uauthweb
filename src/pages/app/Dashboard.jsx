...
function DashboardPage() {
    ...
    return(
        <>
            {/*
            <div className="flex justify-between items-center 2xl:mx-20 xl:mx-10 lg:mx-10 md:mx-0 sm:mx-0">
            ...
            2xl:mx-20 xl:mx-10 lg:mx-10 md:mx-0 sm:mx-0 mt-5 2xl:mb-20 xl:mb-10 lg:mb-10 md:mb-0 sm:mb-0 2xl:rounded-2xl xl:rounded-2xl lg:rounded-2xl md:rounded-none sm:rounded-none 
            */}
            <div className=" bg-slate-50 flex min-h-screen">
                ...
                <div className="flex-1  p-7 overflow-auto">
                    <div className="flex items-center flex-row">
                        <h1 className="font-logo text-neutral-900 text-4xl font-semibold"> 
                            <a href="/console">
                                {(Project.name || 'null').toUpperCase()}
                            </a>
                        </h1>
